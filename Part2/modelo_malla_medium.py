...
nodes = [11-1,18-1,14-1,17-1,13-1,16-1,12-1,15-1,10-1]
...
write_element_data("sigma_x_medium.msh", elementos, σxx, "Sigma_x")
write_element_data("new_sigma_x_medium.msh", elementos, new_σxx, "New_Sigma_x")
